...
import { videos, categories } from "@/data/sample";
import VideoCard from "@/components/VideoCard";

export const metadata: Metadata = {
  title: "動画一覧 | BooPicks",
  description: "ビジネスに役立つ動画コンテンツを毎日配信。テクノロジー、マネー、キャリアなど幅広いジャンルをカバー。",
};
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-white border-b">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
          <h1 className="text-3xl font-bold text-gray-900 mb-4">動画</h1>
          <p className="text-gray-600 max-w-2xl">
            ビジネスの最前線で活躍する専門家による動画コンテンツ。
            スキルアップに役立つ情報を毎日お届けします。
          </p>
        </div>
      </section>
